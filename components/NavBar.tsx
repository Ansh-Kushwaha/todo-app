...
function NavBar() {
  ...
  return (
    <div className="h-12 w-full flex flex-row justify-between px-4 items-center bg-gray-100 dark:bg-[#121212] rounded-b-lg shadow-lg dark:shadow-[#4a4a4a1f]">
        ...
        {showMenu && 
        <div className='absolute top-[64px] right-[10px] flex flex-col items-center rounded-md w-[120px] h-fit shadow-lg dark:shadow-[#4a4a4a1f] bg-slate-100 dark:bg-[#121212] z-999'>
          <div>
            {session && 
          ...
          <button className='btn btn-neutral btn-sm text-gray-50 text-sm my-5 z-999'
            onClick={() => {signOut()}}
          >
            Logout
          </button>
